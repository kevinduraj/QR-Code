...
import static chaincode.FFT.fft1D;
import static chaincode.FFT.ifft1D;
import static chaincode.FFT.ifftShift1D;
import java.awt.Color;
import java.awt.image.BufferedImage;
import java.util.ArrayList;
import tao.AbstractBufferedImageOp;
...
public class BoundaryFilterOp extends AbstractBufferedImageOp{
  ...
  public BufferedImage filter(BufferedImage src, BufferedImage dest) {
    ...
    Complex[] fourier = ifftShift1D(fft1D(signal));
